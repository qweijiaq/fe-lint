...
describe('Validate JS configs', () => {
  it('Validate wj-fe-eslint-config', async () => {
  ...
  it('Validate wj-fe-eslint-config/es5', async () => {
  ...
  it('Validate wj-fe-eslint-config/vue', async () => {
  ...
  it('Validate wj-fe-eslint-config/essential', async () => {
  ...
  it('Validate wj-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate wj-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate wj-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate wj-fe-eslint-config/node', async () => {
